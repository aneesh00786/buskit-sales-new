...
//     // The list of base locales you want to support out of the box
//     // List<String> locales = ['en']; 
//      List<String> locales = [
//   'en', 'hi', 'ar', 'zh-CN', 'zh-TW', 'fr', 'de', 'es', 'pt', 'ru',
//   'ja', 'ko', 'it', 'nl', 'pl', 'uk', 'tr', 'fa', 'he', 'sv',
//   'no', 'da', 'fi', 'el', 'cs', 'sk', 'hu', 'ro', 'bg', 'hr',
//   'sl', 'et', 'lv', 'lt', 'id', 'ms', 'tl', 'vi', 'th', 'km',
//   'my', 'ur', 'bn', 'si', 'ne', 'am', 'sw', 'yo', 'af', 'zu',
//   'ka', 'hy', 'az', 'kk', 'uz', 'mn', 'so', 'mt', 'is', 'be'
// ];
