...
Future<void> addToCart(
  ...
  try {
    existingCartItem = _cartBox.values.firstWhere((cartItem) =>
  ...
  if (existingCartItem != null) {
    ...
    existingCartItem.totalPrice = isPack
      ? (existingCartItem.detail.count * existingCartItem.detail.pieces! * num.parse(existingCartItem.detail.sellPrice ?? '0')).toInt()
      : (existingCartItem.detail.count * num.parse(existingCartItem.detail.sellPrice ?? '0')).toInt();
    ...
    final totalAmount = isPack
      ? (localCount * detail.pieces! * num.parse(detail.sellPrice ?? '0')).toInt()
