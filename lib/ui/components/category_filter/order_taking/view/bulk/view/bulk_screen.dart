...
//   // --- Quantity Manager Widget (Similar to Cart Dialogue) ---
//   Widget _buildQuantityManager() {
//     // Using the blue color from your Add button as the primary color
//     const Color primaryColor = Color(0xFF4285F4); 

//     return Container(
//       width: 120, // Adjusted width for bulk screen
//       height: 45,
//       decoration: BoxDecoration(
//         borderRadius: BorderRadius.circular(8),
//         color: const Color.fromARGB(255, 241, 240, 240),
...
//     return Row(
//       children: [
//         // 1. Add the Quantity Manager here
//         _buildQuantityManager(),
        
//         const SizedBox(width: 20), // Spacing between manager and Add button
...
//                   // 5. USE THE SELECTED QUANTITY HERE
//                   localCount: _currentQuantity, 
...
//                       // 6. ALSO PASS QUANTITY TO STOCK/COUNT IF NEEDED BY YOUR LOGIC
//                       // (Usually 'stock' in addToCart context implies quantity being added or inventory check)
//                       stock: _currentQuantity, 
...
//                 borderRadius: BorderRadius.circular(8),
//               ),
//               // Increase button height to match quantity manager
//               minimumSize: const Size(double.infinity, 45), 
//             ),
//             child: const Text("Add",
//                 style: TextStyle(
