...
//                           ],
//                         ),
//                         if (invoice && !isPhonePortrait(context)) ...[
//                           const Spacer(),
//                           Column(
//                             crossAxisAlignment: CrossAxisAlignment.start,
//                             children: [
...
//                               style: TextStyle(
//                                 fontSize: 12,
//                                 color: orderInvoiceData.paymentStatus == 0
//                                     ? Colors.red
//                                     : Colors.green,
//                               ),
//                             ),
...
import 'package:busskit_salesexecutive/ui/view/ui/dashboard1/dashboard_controller.dart';
// Import the OrderProcessInvoiceDialog
import 'package:busskit_salesexecutive/ui/view/ui/orders/widget/order_invoice.dart'; // Ensure path is correct
import 'package:flutter/material.dart';
import 'package:get/get.dart';
...
void showDetailedOrderInvoiceDialog(
  ...
  // Load the specific data (same as before)
  var orderInvoiceData = await dashBoardController.loadSpecificOrderInvoiceData(
      orderId: orderId.toString());

  // Display the generalized dialog instead of building a custom one
  showDialog(
    // ignore: use_build_context_synchronously
    context: context,
    builder: (BuildContext context) {
