...
class _ProductGridPromoState extends State<ProductGridPromo> {
  ...
  void didUpdateWidget(covariant ProductGridPromo oldWidget) {
    ...
    if (widget.id != oldWidget.id ||
        widget.optionName != oldWidget.optionName) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        setState(() {
          selectedSubCategoryId = widget.id;
          selectedSubCategoryName = widget.optionName;
        });
  ...
  Future<void> _fetchInitialProducts() async {
    try {
      SubCategoryItem? subCategoryItem = getInitialSubCategoryIdAndName();
  ...
  SubCategoryItem? getInitialSubCategoryIdAndName() {
    try {
      if (widget.categoryData.data != null &&
          widget.categoryData.data!.isNotEmpty) {
        var firstCategory = widget.categoryData.data!.first;
