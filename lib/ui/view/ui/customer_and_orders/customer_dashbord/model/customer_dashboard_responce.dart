...
//     message = json['message'] as String?;
//     data = (json['data'] as Map<String, dynamic>?) != null
//         ? CustomerDashboardData.fromJson(json['data'] as Map<String, dynamic>)
//         : null;
//   }
//
//   Map<String, dynamic> toJson() {
...
//   List<CustomerCategoryPerformance>? categoryPerformance;
//   List<RecentOrders>? recentOrders;
//   List<FrequantliyProductLists>? frequantliyProductLists;
...
//   });
//
//   CustomerDashboardData.fromJson(Map<String, dynamic> json) {
//     categoryPerformance = (json['category_performance'] as List?)
//         ?.map((dynamic e) =>
//             CustomerCategoryPerformance.fromJson(e as Map<String, dynamic>))
//         .toList();
//     recentOrders = (json['recent_orders'] as List?)
//         ?.map((dynamic e) => RecentOrders.fromJson(e as Map<String, dynamic>))
//         .toList();
//     frequantliyProductLists = (json['frequantliy_product_lists'] as List?)
//         ?.map((dynamic e) =>
//             FrequantliyProductLists.fromJson(e as Map<String, dynamic>))
...
//         categoryPerformance?.map((e) => e.toJson()).toList();
//     json['recent_orders'] = recentOrders?.map((e) => e.toJson()).toList();
//     json['frequantliy_product_lists'] =
//         frequantliyProductLists?.map((e) => e.toJson()).toList();
//     json['year_list'] = yearList?.map((e) => e.toJson()).toList();
//     return json;
//   }
// }
//
// class CustomerCategoryPerformance {
//   int? cid;
//   String? category;
//   int? count;
//   List<Month>? month;
//
//   CustomerCategoryPerformance({
//     this.cid,
//     this.category,
//     this.count,
//     this.month,
//   });
//
//   CustomerCategoryPerformance.fromJson(Map<String, dynamic> json) {
//     cid = json['cid'] as int?;
//     category = json['category'] as String?;
//     count = json['count'] as int?;
//     month = (json['month'] as List?)
