...
>>>>>>> dd766a8bd0954c77d8a373f356044cfdb1f9e07a
  ...
  Future<void> _checkAttendanceRequirement() async {
    ...
    try {
      ...
      String dayListStr = settings
              .firstWhere((e) => e.key == 'day_list',
                  orElse: () => AllCompanySettingsData(value: ''))
              .value ??
          '';

      String startTimeStr = "09:00";
      String toTimeStr = settings
              .firstWhere((e) => e.key == 'to_time',
                  orElse: () => AllCompanySettingsData(value: ''))
              .value ??
          '';
  ...
  bool _shouldPromptCheckIn(String dayList, String startTime, String endTime) {
    ...
    try {
      ...
      startDt =
          DateTime(now.year, now.month, now.day, startDt.hour, startDt.minute);
