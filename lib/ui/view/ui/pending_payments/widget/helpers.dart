...
Widget buildHeader(BuildContext context,ScrollController headerScrollController) {
  ...
  Widget buildOrderList(
      BuildContext context, PendingPaymentController orderController,ScrollController orderScrollController) {
    double headerHeight = ResponsiveInfo.isMobileDimension(context) ? 53 : 58;
    return Align(
      alignment: FractionalOffset.topCenter,
      child: Container(
                ...
                child: Scrollbar(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                        itemCount:
                           orderController.orderDataList.length + 1,
                        itemBuilder: (context, index) {
                          if (index <
                              orderController.orderDataList.length) {
                            final customerData =
                                orderController.orderDataList[index];
