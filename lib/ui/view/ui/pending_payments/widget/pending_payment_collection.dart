                  ...
                  child: SizedBox(
                    ...
                    child: Obx(() => DataTable(
                          ...
                          rows: controller.individualPendingPayments
                            ...
                            bool isOfflinePending = isOfflinePaymentPending(
                                  ...
                                  child: Text(
                                    payment.orderCreatAt != null &&
                                        ...
                                        ? TimeUtils.formatTimeInZone(
                                            DateTime.parse(payment.orderCreatAt
                                                .toString()),
                                            format: 'dd-MM-yyyy'
                            ...
                            onPressed: () async {
                              ...
                              if (selectedPaymentMethod.value ==
                                ...
                                if (!isOnlineForSubmit) {
                                  showCustomToastDisplay(
                                      context,
                                      "Internet required to create a payment link."
                                          .tr,
                                      Colors.red,
                                      Icons.wifi_off);
                                  return;
                                ...
                                if (!isOnlineForSubmit) {
                                  showDialog(
                                    ...
                                    builder: (ctx) => AlertDialog(
                                      ...
                                      content: Text(
                                          "QR Payments can only be processed while online."
                                              .tr),
                                      actions: [
                                        TextButton(
