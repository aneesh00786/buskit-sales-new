      ...
      if (storedData != null) {
        for (var item in storedData) {
          if (item is Map && item['key'] == 'time_zone') {
            ...
            debugPrint(
                '✅ Successfully loaded TimeZone from Hive: $_companyTimeZone');
            return;
          }
        }
        ...
        child: ConstrainedBox(
          ...
          child: Container(
            width: MediaQuery.of(context).size.width *
                0.95, // Made slightly wider to fit 5 columns
                          ...
                          child: Table(
                            ...
                            children: [
                              ...
                              ...dataList.asMap().entries.map((entry) {
                                ...
                                final visitDate = DateTime(item.visitDate.year,
                                    item.visitDate.month, item.visitDate.day);
                                ...
                                return TableRow(
                                  ...
                                  children: [
                                    ...
                                    _DataCell(
                                      item.checkIn != null
                                          ? _TimeWithLocation(
                                              time: TimeUtils.formatTimeInZone(
                                              item.checkIn!,
                                            ))
                                          : const SizedBox(),
                                    ),
