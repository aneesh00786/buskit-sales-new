              ...
              child: Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  child: isMobile
                      ? Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: _buildFilters(context, fieldWidth, isMobile),
                        )
                      : Row(
...
List<Widget> _buildFilters(
    BuildContext context, double fieldWidth, bool isMobile,) {
      ...
      child: DropdownButton<FilterDateEnum>(
        ...
        items: [
          ...
          DropdownMenuItem(
            ...
            child: Padding(
              padding: const EdgeInsets.all(10.0),
              child: CustomText(content: 'Range', fontSize: 14, fontWeight: FontWeight.bold),
            ),
          ),
        ],
        isExpanded: true,
  ...
  width: fieldWidth,
    ...
    child: TextField(
      ...
      onChanged: (value) {
        salesReturnController.setOrderORIdSearch(value); // <-- call setter
      },
      decoration: InputDecoration(
          ...
          child: ElevatedButton(
            onPressed: () async {
              ...
              if (salesReturnController.selectedFilter == FilterDateEnum.range) {
                ...
                if(s==null || e==null){
                  showCustomToastDisplay(
                      context, "Please select valid date range!", Colors.red, Icons.close);
                  return;
                }
                if(e.isBefore(s)){
                  showCustomToastDisplay(
                      context, "End date cannot be before start date", Colors.red, Icons.close);
                  return;
                } 
